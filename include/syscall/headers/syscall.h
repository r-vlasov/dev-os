...
{ \
  int a; \
  asm volatile("int $128" : "=a" (a) : "0" (num), "b" ((int)p1)); \
  return a; \
}
...
DECL_SYSCALL1(tty_write_address, unsigned long);
DECL_SYSCALL1(tty_write_string, const char*);
DECL_SYSCALL1(tty_out_char, char);
